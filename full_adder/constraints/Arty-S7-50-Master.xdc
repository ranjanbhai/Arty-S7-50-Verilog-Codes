...
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports { c_in }]; #IO_L21N_T3_DQS_A18_15 Sch=sw[2]
...
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS33 } [get_ports { c_out }]; #IO_L17P_T2_A26_15 Sch=led[3]
